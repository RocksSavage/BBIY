...
namespace CS5410
{
    ...
    {
        public static void PrintWithOutline(string message, GraphicsDeviceManager m_graphics, SpriteBatch m_spriteBatch, Vector2 stringSize, SpriteFont m_font, Color fillColor, Color outlineColor)
        {
