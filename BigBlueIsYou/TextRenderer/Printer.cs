...
namespace CS5410
{
    ...
    {
        public void printWithOutline(string message, GraphicsDeviceManager m_graphics, SpriteBatch m_spriteBatch, Vector2 stringSize, SpriteFont m_font, Color color, Color outlineColor)
        {
